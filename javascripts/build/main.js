...
var _PlayJsx = require('./Play.jsx');

var _PlayJsx2 = _interopRequireDefault(_PlayJsx);
...
var Wrapper = (function (_React$Component) {
  ...
  _createClass(Wrapper, [{
    ...
    value: function render() {
      ...
      Mount = authenticated ? _PlayJsx2['default'] : _AuthJsx2['default'];
      return _react2['default'].createElement(Mount, null);
    }
  }]);
...
},{"./Auth.jsx":1,"./Play.jsx":3,"react":160}],5:[function(require,module,exports){
